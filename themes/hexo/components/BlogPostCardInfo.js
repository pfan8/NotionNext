      ...
      <div>
        ...
        <div className="text-gray-400 justify-between flex">
          ...
          <Link
            ...
            passHref
            className="font-light menu-link cursor-pointer text-sm mr-1 min-w-24 h-fit pb-1"
          >
          ...
          <Link
            ...
            passHref
            className="font-light menu-link cursor-pointer text-sm mr-3 min-w-24 h-fit pb-1"
          >
            <i className="far fa-edit mr-1" />
            {post?.lastEditedDay}
          </Link>

          <div className="md:flex-nowrap flex-wrap md:justify-start inline-block ml-auto">
            <div>
              {' '}
